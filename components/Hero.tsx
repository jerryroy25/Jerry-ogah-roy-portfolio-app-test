  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center px-6 pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          Stop Wasting 40+ Hours Every Month. Scale Your Business with Digital Employees.
        </motion.h1>
        ...
        >
          <div className="flex gap-2 items-start mb-4">
            ...
            <div className="text-lg md:text-xl text-slate-400 font-mono leading-relaxed">
              <TerminalText 
                text="I build production-grade AI agents that replace manual chaos with engineering-grade systems. You focus on strategy; I’ll automate the rest." 
                delay={20}
              />
            </div>
          </div>
